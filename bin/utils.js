...
function parseSentence(words){
    var sentence = "";
    // start from index 1 as index 0 is the language we are going to transalte to
...
function parseLanguage(language){
    // we need to check if the language is supported by the terminal or not and return the ISO code of the language we stored in the map
    var lang; 
